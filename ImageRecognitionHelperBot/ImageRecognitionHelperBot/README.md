...
- In a terminal, navigate to `ImageRecognitionHelperBot`

    ```bash
    # change into project folder
    cd ImageRecognitionHelperBot
    ```
...
- Run the bot from a terminal or from Visual Studio, choose option A or B.
  ...
  - Navigate to `ImageRecognitionHelperBot` folder
  - Select `ImageRecognitionHelperBot.csproj` file
