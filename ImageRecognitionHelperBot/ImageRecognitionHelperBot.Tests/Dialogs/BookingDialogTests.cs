...
using ImageRecognitionHelperBot.Tests.Common;
using ImageRecognitionHelperBot.Tests.Dialogs.TestData;
...
using ImageRecognitionHelperBot.Dialogs;

namespace ImageRecognitionHelperBot.Tests.Dialogs
{
